#include <stdio.h>
#include "social_robot_arm_sdk/social_robot_arm_task_control.h"
...
void TaskControl::getTaskVelocity(std::vector<double_t> &arm_vel)
{
  arm_vel = des_arm_vel_;
}

void TaskControl::getTaskAcceleration(std::vector<double_t> &arm_accel)
{
  arm_accel = des_arm_accel_;
}
